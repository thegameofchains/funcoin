...
uint256 hashGenesisBlock("0x6e4490acb07100ec63272019ab632d3ce80972fba931651cfe3aa61d7b624e3a");
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x9c660f546ff9a9b7682ee75a4c2c536ed3be9111f9cf59e0e88e4de0ad524b53");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Doug Jones defeats Roy Moore is Alabame Semate election";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1590559716;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2085015747;

        if (fTestNet)
        {
            block.nTime    = 1590559697;
            block.nNonce   = 385573430;
        }
	...
	if (false && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0x29e9ccb9de5c1c84ceee497864b67fa829b76cc4f740cccfcf765044835f5595"));
        block.print();
